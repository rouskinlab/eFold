...
data_path = "/n/data1/hms/microbiology/rouskin/lab/projects/deep_learning/eFold/data/test_sets/lncRNA_nonFiltered.json"
...
df.to_csv("/n/data1/hms/microbiology/rouskin/lab/projects/deep_learning/eFold/data/test_sets/lncRNA_nonFiltered_f1_baseline_dwld_reboot.csv", index=False)
print(df.tail())